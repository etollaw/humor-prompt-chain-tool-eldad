  ...
  return (
    <div>
      ...
      <div className="mt-4 space-y-3">
        {flavors?.map((flavor) => (
          <form key={String(flavor.id)} action={updateHumorFlavor} className="grid gap-2 rounded-xl border border-zinc-200 bg-white p-4 sm:grid-cols-[1fr_2fr_auto_auto] dark:border-zinc-800 dark:bg-zinc-900">
